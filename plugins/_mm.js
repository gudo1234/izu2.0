...
╰────────────────┈➤`.trim()
    ...
    const nativeFlowPayload = {
      ...
      // NOTA: aquí incluimos el contextInfo a nivel del payload interactivo para que WhatsApp lo acepte
      contextInfo
    }

    // 🔹 Envío del mensaje — añadimos messageContextInfo + contextInfo con quotedMessage DENTRO del interactiveMessage
    await conn.relayMessage(
      m.chat,
      {
        viewOnceMessage: {
          message: {
            ...
            interactiveMessage: {
              ...nativeFlowPayload,
              // aquí combinamos tu banner con los metadatos necesarios y agregamos quotedMessage
              contextInfo: {
      ...
      { quoted: m } // <-- esto también lo dejamos, importante para algunas implementaciones
    )
  } catch (e) {
