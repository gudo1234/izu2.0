...
if (!text) return conn.reply(m.chat, `${e} *Ejemplo de búsqueda:* ${usedPrefix + command} mia Khalifa`, m)
...
return conn.reply(m.chat, `${e} Bloqueo de búsqueda por contenido sexual.`, m)
m.react('✖️')  
try {
