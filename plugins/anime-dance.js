/* 
${e} Codígo creado por Destroy
${e} https://github.com/The-King-Destroy/Yuki_Suou-Bot.git 
*/
...
let handler = async (m, { conn, usedPrefix }) => {
    ...
    let str = m.mentionedJid.length > 0 || m.quoted 
        ? `\`${name2}\` está bailando con \`${name || who}\` (ﾉ^ヮ^)ﾉ*:・ﾟ${e}` 
        : `\`${name2}\` está bailando (ﾉ^ヮ^)ﾉ*:・ﾟ${e}`
