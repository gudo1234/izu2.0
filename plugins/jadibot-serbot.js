...
let drm1 = ""
let drm2 = ""
let rtx = "Con otro celular o en la PC escanea este QR para convertirte en un *Sub-Bot* Temporal.\n\n\`1\`Haga clic en los tres puntos en la esquina superior derecha\n\n\`2\`Toque dispositivos vinculados\n\n\`3\`Escanee este codigo QR para iniciar sesion con el bot\n\n✧ ¡Este código QR expira en 45 segundos!."
...
if (!globalThis.db.data.settings[conn.user.jid].jadibotmd) return m.reply(`${e} Comando desactivado temporalmente.`)
